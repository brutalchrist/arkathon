	...
	def mostrarHighScore(self):
		...
		while 1:
			if pygame.font:
				...
				n1 = n1.render('1. ' + str(self.hgScore.get("primero", "nombre")).translate(self.nombreTablaVie), 0, (255, 0, 0))
				n2 = n2.render('2. ' + str(self.hgScore.get("segundo", "nombre")).translate(self.nombreTablaVie), 0, (255, 0, 0))
				n3 = n3.render('3. ' + str(self.hgScore.get("tercero", "nombre")).translate(self.nombreTablaVie), 0, (255, 0, 0))
				n1score = n1score.render(str(self.hgScore.get("primero", "score")).translate(self.scoreTablaVie), 0, (255, 255, 255))
				n2score = n2score.render(str(self.hgScore.get("segundo", "score")).translate(self.scoreTablaVie), 0, (255, 255, 255))
				n3score = n3score.render(str(self.hgScore.get("tercero", "score")).translate(self.scoreTablaVie), 0, (255, 255, 255))
